#Tableau to Monday.com Web Data Connector
The files in the TableauMondayConnector folder have been written to extract data from Monday.com, so it can be accessed by Tableau to create visualisations and conduct data analysis.
